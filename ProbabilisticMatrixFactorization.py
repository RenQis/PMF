...
class PMF(object):
    ...
    def fit(self, train_vec, test_vec):
        ...
        if ((not incremental) or (self.w_Item is None)):
            ...
            #print(self.w_Item_inc,self.w_User_inc)
    ...
    def predict(self, invID):
        return np.dot(self.w_Item, self.w_User[int(invID), :]) + float(1.0)  # numpy.dot 点乘
